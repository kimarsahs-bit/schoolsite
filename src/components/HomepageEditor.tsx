...
const HomepageEditor = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const data = await getSupabaseData('royal-academy-homepage', {
          // Hero Section
          heroTitle: "Royal Academy",
          heroSubtitle: "Shaping tomorrow's leaders through excellence in education, character development, and innovative learning experiences.",
          heroButtonPrimary: "Apply for Admission",
  ...
  const saveData = async () => {
    try {
      ...
      await setSupabaseData('royal-academy-homepage', homepageData);
        ...
        >
          ...
          <div className="bg-card border border-border rounded-lg p-4 sm:p-6">
            ...
            <div className="space-y-4">
              ...
              {homepageData.bannerImages && homepageData.bannerImages.length > 0 && (
