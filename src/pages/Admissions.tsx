              ...
              <div className="flex items-center justify-between py-3 px-2 sm:py-4 sm:px-4">
                ...
                >
                  <Button
                    ...
                    className="glass-button backdrop-blur-md bg-gradient-to-r from-sky-500 via-blue-600 to-sky-500 text-white font-bold border-2 border-blue-400 hover:border-sky-500 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.03]"
                  >
      ...
      <section className="relative pt-24 sm:pt-32 pb-12 sm:pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            ...
            className="absolute top-10 right-10 w-64 h-64 rounded-full bg-gradient-radial from-gold/20 to-transparent blur-xl hidden sm:block"
          />
          <motion.div
            animate={{
              y: [0, 15, 0],
            ...
            className="absolute bottom-20 left-10 w-48 h-48 rounded-full bg-gradient-radial from-crimson/20 to-transparent blur-xl hidden sm:block"
          />
        </div>
        ...
        <div className="container-wide relative z-10 px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              >
                <h1 className="text-2xl xs:text-3xl sm:text-5xl md:text-6xl font-heading font-bold mb-3 sm:mb-6 leading-tight text-gradient-gold">
                ...
                <p className="text-sm xs:text-base sm:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-4 sm:mb-8">
            ...
            <div className="lg:col-span-5">
              ...
              >
                ...
                <div className="absolute top-4 right-4 w-16 h-16 rounded-full bg-gradient-to-br from-blue-400/40 to-purple-500/40 blur-lg animate-pulse hidden sm:block" />
                <div className="absolute bottom-5 left-4 w-12 h-12 rounded-full bg-gradient-to-br from-purple-400/40 to-red-500/40 blur-md animate-pulse hidden sm:block" style={{ animationDelay: '0.5s' }} />
              </motion.div>
            </div>
          </div>
        </div>
      ...
      <section id="requirements" className="section-padding bg-gradient-to-r from-royal/5 via-background to-crimson/5">
        <div className="container-wide">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl font-heading font-bold mb-4 sm:mb-6 bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-600 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mb-8 sm:mb-12">
            {(admissionsData?.requirements?.categories || requirements).map((req, index) => (
              <motion.div
                ...
                className="card-3d p-4 sm:p-6 md:p-8 bg-gradient-to-br from-blue-500/10 to-cyan-500/5 border border-blue-500/20 hover:border-blue-400/50 transition-all duration-300"
              >
                <h3 className="text-lg sm:text-xl font-heading font-semibold mb-3 sm:mb-4 bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mobile-wrap">{req.title || req.category}</h3>
                <div className="space-y-4">
                  {(req.items || []).map((item, idx) => (
                    ...
                    >
                      ...
                      <span className="text-sm sm:text-base text-muted-foreground mobile-wrap">{item}</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
            {(admissionsData?.requirements?.specialSections || [
              ...
              >
                <h3 className="text-lg sm:text-xl font-heading font-semibold mb-3 sm:mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mobile-wrap">{section.title}</h3>
                <p className="text-sm sm:text-base text-muted-foreground mobile-wrap">{section.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-4 sm:gap-8">
            {(admissionsData?.dates?.deadlines || deadlines).map((deadline, index) => (
              <motion.div
                ...
                className="card-3d p-4 sm:p-6 md:p-8 flex flex-col sm:flex-row items-center gap-3 sm:gap-6 bg-gradient-to-r from-yellow-500/10 to-red-500/10 border border-yellow-500/20 hover:border-red-400/50 transition-all"
              >
                <motion.div
                  whileHover={{ rotateY: 180 }}
                  transition={{ duration: 0.6 }}
                  className="flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-xl admission-step-circle-purple text-white flex flex-col items-center justify-center shadow-lg"
                >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-3 mobile-wrap clamp-3">{deadline.description}</p>
          ...
          >
            <div className="text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <style>{`
                  .apply-btn{display:inline-flex;align-items:center;gap:.6rem;padding:.7rem 1.2rem;border-radius:9999px;font-weight:700;background-image:linear-gradient(90deg,#02204a 0%, #1157d1 55%, #69a8ff 100%);color:#fff;box-shadow:0 8px 28px rgba(2,12,50,0.42);border:none;transition:transform .18s ease, box-shadow .18s ease}
                  .apply-btn:hover{transform:translateY(-3px) scale(1.03);box-shadow:0 16px 36px rgba(2,12,50,0.55)}
                  .contact-btn{display:inline-flex;align-items:center;gap:.6rem;padding:.7rem 1.2rem;border-radius:12px;font-weight:700;background:linear-gradient(90deg,#1f2937 0%, #0b6596 100%);color:#ffd27a;box-shadow:0 8px 22px rgba(11,101,150,0.18);border:none;transition:transform .18s ease, filter .18s}
                  .contact-btn:hover{transform:translateY(-3px) scale(1.02);filter:brightness(1.05)}
                  @media (prefers-reduced-motion: reduce){.apply-btn,.contact-btn{transition:none!important}}
                `}</style>
                <button 
                  onClick={() => setShowContactModal(true)}
