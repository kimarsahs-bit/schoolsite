...
export default function NotFound() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-background via-royal/5 to-crimson/10 flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-6xl bg-card/80 backdrop-blur-md border border-border rounded-2xl shadow-2xl overflow-hidden">
          {/* Header */}
          <header className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 p-4 sm:p-6 bg-gradient-to-r from-gold/10 via-royal/5 to-crimson/10 border-b border-border">
            <div className="text-center lg:text-left">
              <div className="text-sm font-bold text-gold uppercase tracking-wider mb-2">404</div>
              <h1 className="text-3xl md:text-4xl font-heading font-bold mb-2 leading-tight">Lost? Play a game while you're here.</h1>
              <p className="text-muted-foreground">That page doesn't exist. Have some fun, then jump back home.</p>
            </div>
            <div className="flex justify-center lg:justify-end">
              <Link to="/" className="btn-royal px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 w-full sm:w-auto text-center">
                Go Home
              </Link>
            </div>
          </header>
          ...
          {/* Content */}
          <section className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-4 sm:gap-6 p-4 sm:p-6">
            {/* Scoreboard */}
            <aside className="card-3d p-4 sm:p-6">
            ...
            {/* Game Stage */}
            <main className="card-3d p-4 sm:p-6 min-h-[420px] flex flex-col">
              {!active && (
              ...
              {active && (
                <div className="flex flex-col h-full">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 p-4 bg-muted/20 rounded-lg border border-border/50">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                      <button className="btn-ghost px-4 py-2 rounded-lg w-full sm:w-auto" onClick={() => setActive(null)}>
                        Change game
                      </button>
                      <Link to="/" className="btn-gold px-4 py-2 rounded-lg text-center">
                        Go Home
                      </Link>
                    </div>
                  </div>
