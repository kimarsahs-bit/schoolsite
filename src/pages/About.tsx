    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {showScrollTop && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 w-12 h-12 bg-gold text-background rounded-full shadow-lg flex items-center justify-center z-50 hover:bg-gold/90 transition-colors"
